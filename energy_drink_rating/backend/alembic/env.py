...
from backend.dataLayer.Models import Base  # Now this won't throw an error
from sqlalchemy import engine_from_config, pool

# Add the 'backend' folder to the path so 'import models' works
...
config.set_main_option("sqlalchemy.url", conf.Database_Connection_String)
